...
def tests(session):
    ...
    try:
        ...
        session.run(
            ...
            "--omit=src/saltext/rebootmgr/*",
            "--include=tests/*",
        )
        try:
            session.run("coverage", "report", "--show-missing", "--include=src/saltext/rebootmgr/*")
            ...
            #    "--include=src/saltext/rebootmgr/*,tests/*"
            # )
        finally:
