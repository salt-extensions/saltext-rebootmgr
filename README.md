# Salt Extension for Rebootmgr

Salt Extension for interacting with Rebootmgr
...
The saltext-rebootmgr project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-rebootmgr.git

# Change to the repo dir
cd saltext-rebootmgr
```
...
* Writing blog posts
* Sharing your experiences using Salt + Rebootmgr
  on social media
...
[PRs]: https://github.com/salt-extensions/saltext-rebootmgr/pulls
[discussions]: https://github.com/salt-extensions/saltext-rebootmgr/discussions
